...
export default function Form() {
  ...
  const processForm: SubmitHandler<Inputs> = async (data) => {
    console.log(data);
    const submitresearch = await axios.post("/api/addresearch", {
                ...
                <div className="space-y-6 bg-white p-6 rounded-lg shadow-md border border-gray-200">
                  ...
                  <div className="pb-4 border-b border-gray-300">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <p>
                        <strong>AICTE Faculty ID:</strong>{" "}
                        {watch("facultyResearchSchema.aicteFacultyId")}
                      </p>
                      <p>
                    ...
                    <div className="space-y-2">
                      {watch("researchGrantsSchema")?.map((grant, index) => (
                        ...
                        >
                          ...
                          <p>
                            <strong>PhD Awarded:</strong> {grant.anyPhdAwarded}
                          </p>
                        </div>
                      ))}
                    </div>
                  ...
                  <div className="pb-4 border-b border-gray-300">
                      ...
                      {watch("patentsSchema")?.map((patent, index) => (
                        ...
                        >
                          ...
                          <p>
                            ...
                            {patent.author2}, {patent.author3}, {patent.author4}
                          </p>
                        </div>
                      ))}
                    </div>
                    ...
                    <div>
                      ...
                      <div>
                        ...
                        <div className="space-y-2">
                          {watch("researchScholarDetailsSchema")?.map(
                            (scholar, index) => (
                              <div
                                key={index}
                                className="bg-gray-50 p-4 rounded-lg shadow-sm border border-gray-300"
                              >
                                <p>
                                  <strong>Name:</strong>{" "}
                                  {scholar.nameOfResearchScholar}
                                </p>
                                <p>
                                  <strong>University Seat Number:</strong>{" "}
                                  {scholar.universitySeatNumber}
                                </p>
                                <p>
                                ...
                                <p>
                                  <strong>Sanctioned Date:</strong>{" "}
                                  {new Date(
                                    scholar.dateOfRegistration
                                  ).toDateString()}
                                </p>
                                <p>
                                  <strong>University of Registration:</strong>{" "}
                                  {scholar.universityOfRegistration}
                                </p>
                                <p>
                                  <strong>Designation of Supervisor:</strong>{" "}
                                  {scholar.designationOfResearcher}
                                </p>
                                <p>
                                  <strong>Name of Institute:</strong>{" "}
                                  {scholar.nameOfInstitute}
                                </p>
                                <p>
                                  <strong>Progress of Research Work:</strong>{" "}
                                  {scholar.progressOfResearchWork}
                                </p>
                              </div>
                            )
                          )}
                ...
                <div className="mt-6 flex justify-end">
                  <button
                    ...
                    onClick={handleSubmit(async (data) => {
                      try {
                        console.log(data);
                        const response = await axios.post("/api/addresearch", {
                          facultyId,
                          data,
                        });
