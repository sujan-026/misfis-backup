...
export async function POST(request: Request) {
  try {
    ...
    console.log("Received data:", {nationalJournalDetailsSchema, internationalJournalDetailsSchema, nationalConferenceDetailsSchema, internationalConferenceDetailsSchema, researchGrantsSchema, consultancySchema, patentsSchema, researchScholarDetailsSchema, publicationsSchema});
